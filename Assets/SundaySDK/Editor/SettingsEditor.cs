    ...
    public class SettingsEditor : Editor
    {
        ...
        public void LoadFromCSV()
        {
            ...
            if (path.Length != 0)
            {
                ...
                settings.ironSourceAdQualityKey = ReadCSVLine(fileContent, 13);
                settings.facebookAppID = ReadCSVLine(fileContent, 14);
                settings.facebookClientToken = ReadCSVLine(fileContent, 15);
